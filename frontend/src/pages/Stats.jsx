...
const Stats = () => {
  ...
  return (
    ...
    <div className="bg-white text-black">
      ...
      >
        ...
        <img src="https://i.pinimg.com/236x/a4/53/a7/a453a7736f86b3d91de093b35aa7a5b4.jpg" alt=""  style={{height:"350px" , width:"300px"}} srcset="" />
      ...
      >
         <div style={{height:"400px" , width:"300px"}} className="flex flex-col justify-between items-center shadow-2xl">
        <img src="https://i.pinimg.com/236x/6b/b2/d8/6bb2d8d2440adc22bad7b6abf704d268.jpg" alt="" style={{height:"350px" , width:"300px"}} srcset="" />
  ...
  className="ml-20 cursor-pointer hover:text-blue-500"
>
  <div style={{ height: "400px", width: "300px" }} className="relative flex flex-col justify-between items-center shadow-2xl">
    <img
    ...
    <h1 className="text-2xl font-bold mb-3 z-10 text-black">NBA SCORE</h1>
  </div>
</Link>
